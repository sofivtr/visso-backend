...
public class ProductoController {
    ...
    public ResponseEntity<?> eliminarProducto(@PathVariable @Parameter(description = "ID del producto") Long id) {
        ...
        // Verificar si el producto está asociado a algún carrito
        if (productoService.tieneCarritosAsociados(id)) {
            return ResponseEntity.badRequest()
                    .body("No se puede eliminar el producto porque está asociado a uno o más carritos");
        }
